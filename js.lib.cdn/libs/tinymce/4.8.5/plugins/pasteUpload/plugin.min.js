...
(function () {
    var ajaxUrl = 'server.activity/paste-upload.php';
    //console.log("请在生产环境中移除这一行以及修改上面的ajaxUrl。");
    //console.log("please remove this line and replace ajaxUrl with your backend image upload handle in product env");
    var loadingImage = '<img id="loadingImg" src="server.activity/loader6.gif" alt="" />';
    ...
    tinymce.create('tinymce.plugins.PasteUploadPlugin', {
        init: function (ed, url) {
            ...
            function insertIntoTinymce(url) {
                ...
                content = content.replace(loadingImage, '<img src="' + url + '" style="max-width:100%;">');
